/**
 * Initializing Arrays package.
 */
import java.util.Arrays;
/**
 * Class for BinaryST in which Key extends comparable Key.
 *
 * @param      <Key>    The key
...
public final class BinaryST<Key extends Comparable<Key>, Value> {
    /**
     * It Stores the keys in Key array.
     */
    private Key[] keys;
    /**
     * It Stores the values in Value array.
     */
    private Value[] values;
    /**
     * It declares Size of type int.
     */
    private int size;
    /**
     * Constructs the object BinaryST.
     * which has keys, values, size.
     */
    public BinaryST() {
        keys = (Key[]) new Comparable[2];
        values = (Value[]) new Object[2];
        // Initializing with size zero.
        size = 0;
    }
    /**
     * Resizes the array.
     * It doubles the values and key in the array when the array size is full.
     *Arrays.copyOf means it will copy the Array and stores in new Array.
